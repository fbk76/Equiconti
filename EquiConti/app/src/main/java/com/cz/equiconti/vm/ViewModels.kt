...
class OwnerDetailVm @Inject constructor(private val repo: Repo) : ViewModel() {
    ...
    fun load(ownerId: Long) = viewModelScope.launch {
        ...
        _balance.value = repo.db.txnDao().balanceForOwner(ownerId)  // quick access
    }
...
@HiltViewModel
class ReportVm @Inject constructor(private val repo: Repo) : ViewModel() {
